async function __uvHook(e, t={}, a="/fq/") {
    if ("__uv"in e && e.__uv instanceof Ultraviolet)
        return !1;
    e.document && e.window && e.document.querySelectorAll("script[__uv-script]").forEach((e => e.remove()));
    const r = !e.window
      , o = "__uv"
      , n = "__uv$"
      , l = new Ultraviolet({
    ...
    const {client: i} = l
      , {HTMLMediaElement: s, HTMLScriptElement: d, HTMLAudioElement: c, HTMLVideoElement: u, HTMLInputElement: m, HTMLEmbedElement: h, HTMLTrackElement: v, HTMLAnchorElement: g, HTMLIFrameElement: p, HTMLAreaElement: b, HTMLLinkElement: f, HTMLBaseElement: _, HTMLFormElement: y, HTMLImageElement: S, HTMLSourceElement: w} = e;
    i.nativeMethods.defineProperty(e, "__uv", {
        value: l,
        enumerable: !1
    }),
    l.meta.origin = location.origin,
    l.location = i.location.emulate((e => "about:srcdoc" === e ? new URL(e) : (e.startsWith("blob:") && (e = e.slice(5)),
    new URL(l.sourceUrl(e)))), (e => l.rewriteUrl(e))),
    ...
    if ("about:srcdoc" === l.location.href && (l.meta = e.parent.__uv.meta),
    e.EventTarget && (l.addEventListener = e.EventTarget.prototype.addEventListener,
    ...
    i.nativeMethods.defineProperty(i.storage.storeProto, "__uv$storageObj", {
        get() {
            return this === i.storage.sessionStorage ? l.sessionStorageObj : this === i.storage.localStorage ? l.localStorageObj : void 0
        },
        enumerable: !1
    }),
    e.localStorage) {
        for (const t in e.localStorage)
            t.startsWith(n + l.location.origin + "@") && (l.localStorageObj[t.slice((n + l.location.origin + "@").length)] = e.localStorage.getItem(t));
        l.lsWrap = i.storage.emulate(i.storage.localStorage, l.localStorageObj)
    }
    if (e.sessionStorage) {
        for (const t in e.sessionStorage)
            t.startsWith(n + l.location.origin + "@") && (l.sessionStorageObj[t.slice((n + l.location.origin + "@").length)] = e.sessionStorage.getItem(t));
    ...
    let P = e.document ? i.node.baseURI.get.call(e.document) : e.location.href
      , k = l.sourceUrl(P);
    if (i.nativeMethods.defineProperty(l.meta, "base", {
        get: () => e.document ? (i.node.baseURI.get.call(e.document) !== P && (P = i.node.baseURI.get.call(e.document),
        k = l.sourceUrl(P)),
        k) : l.meta.url.href
    }),
    l.methods = {
    ...
    l.filterKeys = [o, l.methods.setSource, l.methods.source, l.methods.location, l.methods.function, l.methods.string, l.methods.eval, l.methods.parent, l.methods.top, n + "protocol", n + "storageObj", n + "url", n + "modifiedStyle", n + "config", n + "dispatched", "Ultraviolet", "__uvHook"],
    i.on("wrap", ( (e, t) => {
        i.nativeMethods.defineProperty(t, "name", i.nativeMethods.getOwnPropertyDescriptor(e, "name")),
        i.nativeMethods.defineProperty(t, "length", i.nativeMethods.getOwnPropertyDescriptor(e, "length")),
    ...
    i.document.on("setCookie", (e => {
        ...
        l.cookie.validateCookie(t, l.meta, !0) && (l.cookieStr.length && (l.cookieStr += "; "),
    ...
    i.element.on("getInnerHTML", (e => {
        if ("SCRIPT" === e.that.tagName)
            e.data.value = l.js.source(e.data.value);
        else
    ...
    i.element.on("getOuterHTML", (e => {
        switch (e.that.tagName) {
        case "HEAD":
            e.data.value = l.sourceHtml(e.data.value.replace(/<head(.*)>(.*)<\/head>/s, "<op-head$1>$2</op-head>")).replace(/<op-head(.*)>(.*)<\/op-head>/s, "<head$1>$2</head>");
            break;
        case "BODY":
            e.data.value = l.sourceHtml(e.data.value.replace(/<body(.*)>(.*)<\/body>/s, "<op-body$1>$2</op-body>")).replace(/<op-body(.*)>(.*)<\/op-body>/s, "<body$1>$2</body>");
            break;
        default:
            e.data.value = l.sourceHtml(e.data.value, {
                document: "HTML" === e.that.tagName
    ...
    i.history.on("replaceState", (e => {
        e.data.url && (e.data.url = l.rewriteUrl(e.data.url, "__uv"in e.that ? e.that.__uv.meta : l.meta))
    }
    )),
    ...
    i.element.on("getAttribute", (e => {
        i.element.hasAttribute.call(e.that, l.attributePrefix + "-attr-" + e.data.name) && e.respondWith(e.target.call(e.that, l.attributePrefix + "-attr-" + e.data.name))
    }
    )),
    i.message.on("postMessage", (e => {
        ...
        e.respondWith(a(e.target, r ? [e.data.message, e.data.transfer] : [e.data.message, e.data.origin, e.data.transfer], e.that))
    }
    )),
    i.message.on("data", (e => {
    ...
    i.overrideDescriptor(e, "origin", {
        get: (e, t) => l.location.origin
    }),
    i.node.on("baseURI", (t => {
        t.data.value.startsWith(e.location.origin) && (t.data.value = l.sourceUrl(t.data.value))
    }
    )),
    i.element.on("setAttribute", (t => {
        if (t.that instanceof s && "src" === t.data.name && t.data.value.startsWith("blob:"))
            return t.target.call(t.that, l.attributePrefix + "-attr-" + t.data.name, t.data.value),
            void (t.data.value = l.blobUrls.get(t.data.value));
        l.attrs.isUrl(t.data.name) && (t.target.call(t.that, l.attributePrefix + "-attr-" + t.data.name, t.data.value),
        t.data.value = l.rewriteUrl(t.data.value)),
        l.attrs.isStyle(t.data.name) && (t.target.call(t.that, l.attributePrefix + "-attr-" + t.data.name, t.data.value),
        t.data.value = l.rewriteCSS(t.data.value, {
            context: "declarationList"
        })),
        l.attrs.isHtml(t.data.name) && (t.target.call(t.that, l.attributePrefix + "-attr-" + t.data.name, t.data.value),
        t.data.value = l.rewriteHtml(t.data.value, {
            ...l.meta,
            document: !0,
            injectHead: l.createHtmlInject(l.handlerScript, l.bundleScript, l.configScript, l.cookieStr, e.location.href)
        })),
        l.attrs.isSrcset(t.data.name) && (t.target.call(t.that, l.attributePrefix + "-attr-" + t.data.name, t.data.value),
        t.data.value = l.html.wrapSrcset(t.data.value)),
        l.attrs.isForbidden(t.data.name) && (t.data.name = l.attributePrefix + "-attr-" + t.data.name)
    }
    )),
    ...
    i.element.hookProperty([d, c, u, s, S, m, h, p, v, w], "src", {
        get: (e, t) => l.sourceUrl(e.call(t)),
        set: (e, t, [a]) => {
            if (new String(a).toString().trim().startsWith("blob:") && t instanceof s)
                return i.element.setAttribute.call(t, l.attributePrefix + "-attr-src", a),
    ...
    i.element.hookProperty([S], "srcset", {
        get: (e, t) => i.element.getAttribute.call(t, l.attributePrefix + "-attr-srcset") || e.call(t),
        set: (e, t, [a]) => {
    ...
    i.element.hookProperty(d, "integrity", {
        get: (e, t) => i.element.getAttribute.call(t, l.attributePrefix + "-attr-integrity"),
        set: (e, t, [a]) => {
            i.element.setAttribute.call(t, l.attributePrefix + "-attr-integrity", a)
        }
    }),
    i.element.hookProperty(p, "sandbox", {
        get: (e, t) => i.element.getAttribute.call(t, l.attributePrefix + "-attr-sandbox") || e.call(t),
        set: (e, t, [a]) => {
    ...
    i.element.hookProperty(p, "srcdoc", {
        get: (e, t) => i.element.getAttribute.call(t, l.attributePrefix + "-attr-srcdoc") || e.call(t),
        set: (t, a, [r]) => {
            t.call(a, l.rewriteHtml(r, {
                document: !0,
                injectHead: l.createHtmlInject(l.handlerScript, l.bundleScript, l.configScript, l.cookieStr, e.location.href)
            }))
        }
    ...
    i.node.on("setTextContent", (e => {
        "SCRIPT" === e.that.tagName && (e.data.value = l.js.rewrite(e.data.value))
    }
    )),
    "serviceWorker"in e.navigator && delete e.Navigator.prototype.serviceWorker,
    i.document.on("getDomain", (e => {
        e.data.value = l.domain
    }
    )),
    i.document.on("setDomain", (e => {
        if (!e.data.value.toString().endsWith(l.meta.url.hostname.split(".").slice(-2).join(".")))
    ...
    i.document.on("parseFromString", (e => {
        if ("text/html" !== e.data.type)
            return !1;
        e.data.string = l.rewriteHtml(e.data.string, {
            ...l.meta,
            document: !0
        })
    }
    ...
    i.attribute.on("getValue", (e => {
        i.element.hasAttribute.call(e.that.ownerElement, l.attributePrefix + "-attr-" + e.data.name) && (e.data.value = i.element.getAttribute.call(e.that.ownerElement, l.attributePrefix + "-attr-" + e.data.name))
    }
    )),
    i.attribute.on("setValue", (t => {
        l.attrs.isUrl(t.data.name) && (i.element.setAttribute.call(t.that.ownerElement, l.attributePrefix + "-attr-" + t.data.name, t.data.value),
        t.data.value = l.rewriteUrl(t.data.value)),
        l.attrs.isStyle(t.data.name) && (i.element.setAttribute.call(t.that.ownerElement, l.attributePrefix + "-attr-" + t.data.name, t.data.value),
        t.data.value = l.rewriteCSS(t.data.value, {
            context: "declarationList"
        })),
        l.attrs.isHtml(t.data.name) && (i.element.setAttribute.call(t.that.ownerElement, l.attributePrefix + "-attr-" + t.data.name, t.data.value),
        t.data.value = l.rewriteHtml(t.data.value, {
            ...l.meta,
            document: !0,
            injectHead: l.createHtmlInject(l.handlerScript, l.bundleScript, l.configScript, l.cookieStr, e.location.href)
        })),
        l.attrs.isSrcset(t.data.name) && (i.element.setAttribute.call(t.that.ownerElement, l.attributePrefix + "-attr-" + t.data.name, t.data.value),
        t.data.value = l.html.wrapSrcset(t.data.value))
    }
    )),
    i.url.on("createObjectURL", (t => {
        ...
        if (a.startsWith("blob:" + location.origin)) {
            let r = "blob:" + ("about:blank" !== l.meta.url.href ? l.meta.url.origin : e.parent.__uv.meta.url.origin) + a.slice(5 + location.origin.length);
            l.blobUrls.set(r, a),
            t.respondWith(r)
        } else
            t.respondWith(a)
    ...
    i.url.on("revokeObjectURL", (e => {
        if (l.blobUrls.has(e.data.url)) {
            const t = e.data.url;
            e.data.url = l.blobUrls.get(e.data.url),
            l.blobUrls.delete(t)
        }
    }
    )),
    ...
    i.storage.on("set", (e => {
        e.that.__uv$storageObj && (e.that.__uv$storageObj[e.data.name] = e.data.value),
        e.data.name = n + l.meta.url.origin + "@" + e.data.name
    }
    )),
    ...
    i.storage.on("length", (e => {
        e.that.__uv$storageObj && e.respondWith(i.nativeMethods.keys.call(null, e.that.__uv$storageObj).length)
    }
    )),
    i.storage.on("key", (e => {
        e.that.__uv$storageObj && e.respondWith(i.nativeMethods.keys.call(null, e.that.__uv$storageObj)[e.data.index] || null)
    }
    )),
    i.websocket.on("websocket", (async t => {
        ...
        const r = {
          ...
          , o = l.cookie.serialize(l.cookies, {
            url: a
        }, !1);
        o && (r.Cookie = o);
        ...
        t.data.url = ("https:" === l.bare.protocol ? "wss://" : "ws://") + l.bare.host + l.bare.pathname + "v1/",
        t.data.protocols = ["bare", l.encodeProtocol(JSON.stringify({
            remote: d,
            headers: r,
    ...
    i.object.on("getOwnPropertyDescriptors", (e => {
        for (const t of l.filterKeys)
            delete e.data.descriptors[t]
    }
    )),
    i.style.on("setProperty", (e => {
        i.style.dashedUrlProps.includes(e.data.property) && (e.data.value = l.rewriteCSS(e.data.value, {
            context: "value",
            ...l.meta
        }))
    }
    ...
    i.style.on("getPropertyValue", (e => {
        i.style.dashedUrlProps.includes(e.data.property) && e.respondWith(l.sourceCSS(e.target.call(e.that, e.data.property), {
            context: "value",
            ...l.meta
        }))
    }
    ...
    "CSS2Properties"in e)
        for (const t of i.style.urlProps)
            i.overrideDescriptor(e.CSS2Properties.prototype, t, {
                get: (e, t) => l.sourceCSS(e.call(t), {
                    context: "value",
                    ...l.meta
                }),
                set: (e, t, a) => {
                    e.call(t, l.rewriteCSS(a, {
                        context: "value",
                        ...l.meta
                    }))
                }
        ...
        "HTMLElement"in e && i.overrideDescriptor(e.HTMLElement.prototype, "style", {
            get: (e, t) => {
                const a = e.call(t);
                    ...
                    for (const e of i.style.urlProps)
                        i.nativeMethods.defineProperty(a, e, {
                            ...
                            get() {
                                ...
                                return l.sourceCSS(t, {
                                    context: "value",
                                    ...l.meta
                                })
                            },
                            set(t) {
                                i.style.setProperty.call(this, i.style.propToDashed[e] || e, l.rewriteCSS(t, {
                                    context: "value",
                                    ...l.meta
                                }))
                            }
    ...
    e.window && l.addEventListener.call(e, "hashchange", (t => {
    ...
    i.location.on("hashchange", ( (t, a, r) => {
        if (r.HashChangeEvent && i.history.replaceState) {
            ...
            const o = new r.HashChangeEvent("hashchange",{
                newURL: a,
                oldURL: t
            });
    ...
    i.override(e, "open", ( (e, t, a) => {
        if (!a.length)
            return e.apply(t, a);
        let[r] = a;
        return r = l.rewriteUrl(r),
        e.call(t, r)
    }
    )),
    l.$wrap = function(e) {
        return "location" === e ? l.methods.location : "eval" === e ? l.methods.eval : e
    }
    ,
    l.$get = function(t) {
        return t === e.location ? l.location : t === e.eval ? l.eval : t === e.parent ? e.__uv$parent : t === e.top ? e.__uv$top : t
    }
    ,
    ...
    i.nativeMethods.defineProperty(e.Object.prototype, l.methods.setSource, {
        value: function(e) {
            return i.nativeMethods.isExtensible(this) ? (i.nativeMethods.defineProperty(this, l.methods.source, {
                value: e,
                writable: !0,
                enumerable: !1
            }),
    ...
    i.nativeMethods.defineProperty(e.Object.prototype, l.methods.location, {
        ...
        set(t) {
            this === e.document || this === e ? l.location.href = t : this.location = t
        }
    }),
